...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"src/interceptor.js":[function(require,module,exports) {
"use strict";
 ...
 */
var getBatchParams = function getBatchParams(url) {
  var requestArr = batchedRequestsMap[url];
  var params = requestArr.map(function (item) {
    return item.params.ids;
  });
  return _toConsumableArray(new Set(params.flat()));
};
 ...
 */
var getUpdatedConfig = function getUpdatedConfig(config) {
  var batchedIds = getBatchParams(config.url);
  if (!batchedIds.length) {
    throw new Error("No batched IDs found");
  }
  var params = _objectSpread(_objectSpread({}, config.params), {}, {
    ids: batchedIds
  });
 ...
 */
var responseResolver = function responseResolver(config) {
  return function (res) {
    var _config$params;
    var ids = ((_config$params = config.params) === null || _config$params === void 0 ? void 0 : _config$params.ids) || [];
    ...
    return Promise.resolve(_objectSpread(_objectSpread({}, res), {}, {
      data: {
        items: items
      }
    }));
 ...
 */
var batchAdapter = function batchAdapter(config) {
  ...
  if (batchedRequestsMap[config.url] && batchedRequestsMap[config.url].length) {
    ...
    batchedRequestsMap = _objectSpread(_objectSpread({}, batchedRequestsMap), {}, _defineProperty({}, config.url, [].concat(_toConsumableArray(batchedRequestsMap[config.url]), [config])));
  } else {
    batchedRequestsMap = _objectSpread(_objectSpread({}, batchedRequestsMap), {}, _defineProperty({}, config.url, [config]));
    batchedRequestPromise[config.url] = new Promise(function (resolve, reject) {
      setTimeout(function () {
        // After a delay, send the batched request

        (0, _http.default)(getUpdatedConfig(config)).then(resolve).catch(function (error) {
          console.error("Network error", error);
          batchedRequestsMap[config.url].forEach(function (waitingRequest) {
            reject(error);
          });
        }).finally(function () {
 ...
 */
function batchInterceptor(_x) {
  return _batchInterceptor.apply(this, arguments);
}
function _batchInterceptor() {
  _batchInterceptor = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(instance) {
                ...
                while (1) switch (_context2.prev = _context2.next) {
                  case 0:
                    if (batchEnabled.hasOwnProperty(request.url)) {
                      ...
                      request.adapter = /*#__PURE__*/function () {
...
var _default = batchInterceptor;
exports.default = _default;
},{"axios/lib/adapters/http":"node_modules/axios/lib/adapters/xhr.js"}],"src/apiClient.js":[function(require,module,exports) {
"use strict";
...
var _interceptor = _interopRequireDefault(require("./interceptor.js"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var instance = _axios.default.create({
  baseURL: "https://europe-west1-quickstart-1573558070219.cloudfunctions.net"
});
(0, _interceptor.default)(instance);
var _default = instance;
exports.default = _default;
},{"axios":"node_modules/axios/index.js","./interceptor.js":"src/interceptor.js"}],"src/index.js":[function(require,module,exports) {
"use strict";
...
function runTest() {
  var batchUrl = "/file-batch-api";

  // Should return [{id:"fileid1"},{id:"fileid2"}]
  _apiClient.default.get(batchUrl, {
    params: {
      ids: ["fileid1", "fileid2"]
    }
...
},{"./apiClient.js":"src/apiClient.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
